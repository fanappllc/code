...
class BookingHistoryData: Mappable {
    ...
    class func map(JSONObject: Any?, context: MapContext?) -> BookingHistoryData {
        return Mapper(context: context).map(JSONObject: JSONObject, toObject: BookingHistoryData())
    }
}
