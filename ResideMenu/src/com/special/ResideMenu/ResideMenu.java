...
public class ResideMenu extends FrameLayout {
    ...
    public LinearLayout reside_headder;
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        if (customLeftMenuId >= 0) {
            ...
            reside_headder = (LinearLayout) scrollViewLeftMenu.findViewById(R.id.reside_headder);
            profileImage = (CircleImageView) scrollViewLeftMenu.findViewById(R.id.imageViewProfile);
            tv_user_name = (TextView) scrollViewLeftMenu.findViewById(R.id.tv_user_name);
            tv_title = (TextView) scrollViewLeftMenu.findViewById(R.id.tv_title);
    ...
    private void setShadowAdjustScaleXByOrientation() {
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            shadowAdjustScaleX = 0.02f;
            shadowAdjustScaleY = 0.02f;
        }
    }
